...
void init (void) {
  ...
  mi_red.equipos_en_red[3] = fb;
  mi_red.equipos_en_red[4] = ugr;
  mi_red.equipos_conectados = 5;
}
...
char ** buscar_1_svc(char *nombre,  struct svc_req *rqstp) {
	static char * result;
  int index;
...
char ** registrar_1_svc(char *nombre, char *ip,  struct svc_req *rqstp) {
	static char * result;
...
char ** borrar_1_svc(char *nombre,  struct svc_req *rqstp) {
	static char * result;
  int index;
