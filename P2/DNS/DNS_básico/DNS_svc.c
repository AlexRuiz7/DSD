...
{
	return (registrar_1_svc(argp->nombre, argp->ip, rqstp));
}
...
main (int argc, char **argv)
{
	...
	if (!svc_register(transp, DNS, DNSV1, dns_1, IPPROTO_UDP)) {
	...
	if (!svc_register(transp, DNS, DNSV1, dns_1, IPPROTO_TCP)) {
