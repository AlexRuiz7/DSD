...
/******************************************************************************/
/**
 * Función de llamada a búsqueda en el servidor DNS 1
 */
char ** buscar_dns_1 (char *nombre){
  CLIENT *clnt;
  static char	 *resultado = "11111";
  char   *host = "localhost";
  ...
  resultado = *dns_1_buscar_1(nombre, clnt);
...
void init (void) {
  ...
  struct Equipo fb  = {"facebook.com","31.13.67.35"		 };
  struct Equipo ugr = {"ugr.es",			"150.214.204.231"};

  mi_red.equipos_en_red[0] = gg;
  mi_red.equipos_en_red[1] = fb;
  mi_red.equipos_en_red[2] = ugr;
...
char ** dns_2_buscar_1_svc(char *nombre,  struct svc_req *rqstp) {
	static char * result;
  int index;
...
char ** dns_2_registrar_1_svc(char *nombre, char *ip,  struct svc_req *rqstp) {
	static char * result;
...
char ** dns_2_borrar_1_svc(char *nombre,  struct svc_req *rqstp) {
	static char * result;
  int index;
