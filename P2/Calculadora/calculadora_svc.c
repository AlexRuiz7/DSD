...
main (int argc, char **argv)
{
	...
	if (!svc_register(transp, CALCULADORA, CALCV1, calculadora_1, IPPROTO_UDP)) {
		fprintf (stderr, "%s", "unable to register (CALCULADORA, CALCV1, udp).");
		exit(1);
	}
	...
	if (!svc_register(transp, CALCULADORA, CALCV1, calculadora_1, IPPROTO_TCP)) {
		fprintf (stderr, "%s", "unable to register (CALCULADORA, CALCV1, tcp).");
		exit(1);
	}
