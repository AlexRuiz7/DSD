...
main (int argc, char **argv)
{
	...
	if (!svc_register(transp, DIRPROG, DIRV1, dirprog_1, IPPROTO_UDP)) {
		fprintf (stderr, "%s", "unable to register (DIRPROG, DIRV1, udp).");
		exit(1);
	}
	...
	if (!svc_register(transp, DIRPROG, DIRV1, dirprog_1, IPPROTO_TCP)) {
		fprintf (stderr, "%s", "unable to register (DIRPROG, DIRV1, tcp).");
		exit(1);
	}
